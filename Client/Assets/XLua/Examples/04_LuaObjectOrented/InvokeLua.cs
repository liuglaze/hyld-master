...
namespace XLuaTest
{
    ...
    public class InvokeLua : MonoBehaviour
    {
        ...
        void Test(LuaEnv luaenv)
        {
            ...
            Logging.HYLDDebug.Log("sum(*10) =" + calc.Add(1, 2));
            calc.Mult = 100;
            Logging.HYLDDebug.Log("sum(*100)=" + calc.Add(1, 2));

            Logging.HYLDDebug.Log("list[0]=" + calc[0]);
            Logging.HYLDDebug.Log("list[1]=" + calc[1]);
        ...
        {
            Logging.HYLDDebug.Log(string.Format("{0} has property changed {1}={2}", sender, e.name, e.value));
        }
