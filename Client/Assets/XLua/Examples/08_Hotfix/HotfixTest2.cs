...
namespace XLuaTest
{
    ...
    public class InnerTypeTest
    {
        public void Foo()
        {
            ...
            Logging.HYLDDebug.Log("{x=" + ret.x + ",y= " + ret.y + "}");
        }
    ...
    public class BaseTestBase<T> : BaseTestHelper
    {
        ...
        {
            Logging.HYLDDebug.Log("BaseTestBase<>.Foo, p = " + p);
        }
    }
    ...
    public class BaseTest : BaseTestBase<InnerTypeTest>
    {
        ...
        {
            Logging.HYLDDebug.Log("BaseTest<>.Foo, p = " + p);
        }
    ...
    public class HotfixTest2 : MonoBehaviour
    {
        ...
        void Start()
        {
            ...
            Logging.HYLDDebug.Log("Hotfix using:" + d1);
            ...
            Logging.HYLDDebug.Log("No Hotfix using:" + d2);

            Logging.HYLDDebug.Log("drop:" + ((d1 - d2) / d1));

            Logging.HYLDDebug.Log("Before Fix: 2 + 1 = " + calc.Add(2, 1));
            Logging.HYLDDebug.Log("Before Fix: Vector3(2, 3, 4) + Vector3(1, 2, 3) = " + calc.Add(new Vector3(2, 3, 4), new Vector3(1, 2, 3)));
            luaenv.DoString(@"
            xlua.hotfix(CS.XLuaTest.HotfixCalc, 'Add', function(self, a, b)
                return a + b
            end)
        ");
            Logging.HYLDDebug.Log("After Fix: 2 + 1 = " + calc.Add(2, 1));
            Logging.HYLDDebug.Log("After Fix: Vector3(2, 3, 4) + Vector3(1, 2, 3) = " + calc.Add(new Vector3(2, 3, 4), new Vector3(1, 2, 3)));

            double num;
            string str = "hehe";
            int ret = calc.TestOut(100, out num, ref str);
            Logging.HYLDDebug.Log("ret = " + ret + ", num = " + num + ", str = " + str);
        ...
        ");
            ...
            Logging.HYLDDebug.Log("r1:" + r1 + ",r2:" + r2);

            string ss = "heihei";
            int r3 = calc.Test2(r1, out r2, ref ss);
            Logging.HYLDDebug.Log("r1:" + r1 + ",r2:" + r2 + ",r3:" + r3 + ",ss:" + ss);

            r3 = HotfixCalc.Test3("test3");
            r3 = HotfixCalc.Test3(2);
            r3 = HotfixCalc.Test3(this);
            Logging.HYLDDebug.Log("r3:" + r3);
            HotfixCalc.Test4(this);
            HotfixCalc.Test4(2);
            calc.Test5(10, "a", "b", "c");
            calc.Test5(10, 1, 3, 5);

            Logging.HYLDDebug.Log("----------------------before------------------------");
            TestStateful();
            System.GC.Collect();
        ...
        ");
            ...
            genericObj.Func1();
            Logging.HYLDDebug.Log(genericObj.Func2());
            luaenv.DoString(@"
        ...
        ");
            ...
            Logging.HYLDDebug.Log("go=" + st.GetGo(123, "john"));
            luaenv.DoString(@"
        ...
        ");
            ...
            Logging.HYLDDebug.Log("gs.GetA()=" + gs.GetA(123));
            luaenv.DoString(@"
        ...
        ");
            ...
            {
                Logging.HYLDDebug.Log("throw in lua an catch in c# ok, e.Message:" + e.Message);
            }


            BaseTestBase<InnerTypeTest> bt = new BaseTest();
            bt.Foo(1);
            Logging.HYLDDebug.Log(bt);
        ...
        void TestStateful()
        {
            ...
            sft.AProp = 10;
            Logging.HYLDDebug.Log("sft.AProp:" + sft.AProp);
            sft["1"] = 1;
            Logging.HYLDDebug.Log("sft['1']:" + sft["1"]);
            System.Action<int, double> cb = (a, b) =>
            {
                Logging.HYLDDebug.Log("a:" + a + ",b:" + b);
            };
            sft.AEvent += cb;
            sft.Start();
            sft.Start();
