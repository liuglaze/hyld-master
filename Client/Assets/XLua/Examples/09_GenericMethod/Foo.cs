...
namespace XLuaTest
{
    ...
    public class Foo
    {
        ...
        {
            Logging.HYLDDebug.Log(string.Format("Test1<{0}>", typeof(T)));
        }

        public T1 Test2<T1, T2>(T1 a, T2 b, GameObject c) where T1 : Foo1Parent where T2 : Foo2Parent
        {
            Logging.HYLDDebug.Log(string.Format("Test2<{0},{1}>", typeof(T1), typeof(T2)), c);
            return a;
        }
        ...
        {
            Logging.HYLDDebug.Log("UnsupportedMethod1");
        }
        ...
        {
            Logging.HYLDDebug.Log(string.Format("UnsupportedMethod2<{0}>", typeof(T)));
        }
        ...
        {
            Logging.HYLDDebug.Log(string.Format("UnsupportedMethod3<{0}>", typeof(T)));
        }
    ...
    public static class FooExtension
    {
        ...
        {
            Logging.HYLDDebug.Log("PlainExtension");
        }

        public static T Extension1<T>(this T a) where T : Foo1Parent
        {
            Logging.HYLDDebug.Log(string.Format("Extension1<{0}>", typeof(T)));
            return a;
        }

        public static T Extension2<T>(this T a, GameObject b) where T : Foo1Parent
        {
            Logging.HYLDDebug.Log(string.Format("Extension2<{0}>", typeof(T)), b);
            return a;
        }

        public static void Extension2<T1, T2>(this T1 a, T2 b) where T1 : Foo1Parent where T2 : Foo2Parent
        {
            Logging.HYLDDebug.Log(string.Format("Extension2<{0},{1}>", typeof(T1), typeof(T2)));
        }
