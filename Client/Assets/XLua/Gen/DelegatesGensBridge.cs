...
namespace XLua
{
    public partial class DelegateBridge : DelegateBridgeBase
    {
		...
		public string __Gen_Delegate_Imp9()
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public string __Gen_Delegate_Imp10(string p0, string p1, string p2)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public override Delegate GetDelegateByType(Type type)
		{
			...
			{
			    return new LuaBehaviour.LuaAction(__Gen_Delegate_Imp8);
			}
		
		    if (type == typeof(LuaBehaviour.ConfigNameList_GetRandomName))
			{
			    return new LuaBehaviour.ConfigNameList_GetRandomName(__Gen_Delegate_Imp9);
			}
		
		    if (type == typeof(LuaBehaviour.ConfigYuanFen_GetData))
			{
			    return new LuaBehaviour.ConfigYuanFen_GetData(__Gen_Delegate_Imp10);
			}
