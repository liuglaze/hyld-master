...
#else
            Logging.HYLDDebug.LogError(info);
#endif
        }
...
namespace XLua
{
    public static class Hotfix
    {
        ...
        public static void HotfixInject()
        {
            ...
            {
                Logging.HYLDDebug.LogError("You can't inject before the compilation is done");
                return;
            }
			...
			if(!File.Exists(mono_path))
			{
				Logging.HYLDDebug.LogError("can not find mono!");
			}
            ...
            {
                Logging.HYLDDebug.LogError("please install the Tools");
                return;
            }
            ...
            foreach (var injectAssemblyPath in injectAssemblyPaths)
            {
                ...
                Logging.HYLDDebug.Log(hotfix_injection.StandardOutput.ReadToEnd());
