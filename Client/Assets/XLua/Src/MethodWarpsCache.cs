...
namespace XLua
{
        ...
        public int Call(RealStatePtr L)
        {
            try
            {
                ...
                if (method.IsDefined(typeof(ObsoleteAttribute), true))
                {
                    ...
                    Logging.HYLDDebug.LogWarning("Obsolete Method [" + method.DeclaringType.ToString() + "." + method.Name + "]: " + info.Message);
                } 
#endif
                object target = null;
                ...
                {
                    //Logging.HYLDDebug.Log("inPos:" + inPosArray[i]);
                    ...
                    //Logging.HYLDDebug.Log("value:" + args[inPosArray[i]]);
                }
                ...
                if (!isVoid)
                {
                    //Logging.HYLDDebug.Log(toInvoke.ToString() + " ret:" + ret);
    ...
    public class MethodWrapsCache
    {
        ...
        {
            //Logging.HYLDDebug.LogWarning("GetConstructor:" + type);
        ...
        {
            //Logging.HYLDDebug.LogWarning("GetMethodWrap:" + type + " " + methodName);
        ...
        {
            //Logging.HYLDDebug.LogWarning("GetDelegateWrap:" + type );
