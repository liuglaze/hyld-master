    ...
    public partial class StaticLuaCallbacks
    {
        ...
        public static int MetaFuncIndex(RealStatePtr L)
        {
            try
            {
                ...
                //Logging.HYLDDebug.Log("============================load type by __index:" + type);
            ...
            try
            {
                ...
                while (true)
                {
                    if (www.isDone || !string.IsNullOrEmpty(www.error))
                    {
                        ...
                        {
                            Logging.HYLDDebug.LogWarning("load lua file from StreamingAssets is obsolete, filename:" + filename);
