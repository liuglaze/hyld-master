...
namespace Tutorial
{
	...
	public class BaseClass
	{
		...
		{
			Logging.HYLDDebug.Log("Derived Static Func, BSF = " + BSF);
		}
		...
		public void BMFunc()
		{
			Logging.HYLDDebug.Log("Derived Member Func, BMF = " + BMF);
		}
	...
	public class DerivedClass : BaseClass
	{
		...
		public void DMFunc()
		{
			Logging.HYLDDebug.Log("Derived Member Func, DMF = " + DMF);
		}
		...
		{
			Logging.HYLDDebug.Log("P1 = {x=" + p1.x + ",y=" + p1.y + "},p2 = " + p2);
			luafunc();
			p2 = p2 * p1.x;
			p3 = "hello " + p1.y;
			csfunc = () =>
			{
				Logging.HYLDDebug.Log("csharp callback invoked!");
			};
			return 1.23;
		}
		...
		{
			Logging.HYLDDebug.Log("TestFunc(int i)");
		}

		public void TestFunc(string i)
		{
			Logging.HYLDDebug.Log("TestFunc(string i)");
		}
		...
		{
			Logging.HYLDDebug.Log("DefaultValueFunc: a=" + a + ",b=" + b + ",c=" + c);
		}

		public void VariableParamsFunc(int a, params string[] strs)
		{
			Logging.HYLDDebug.Log("VariableParamsFunc: a =" + a);
		...
		{
			Logging.HYLDDebug.Log("EnumTestFunc: e=" + e);
			return TestEnum.E2;
		}

		public Action<string> TestDelegate = (param) =>
		{
			Logging.HYLDDebug.Log("TestDelegate in c#:" + param);
		};
		...
		{
			Logging.HYLDDebug.Log("GenericMethod<" + typeof(T) + ">");
		}
	}
	...
	public static class DerivedClassExtensions
    {
		...
		{
			Logging.HYLDDebug.Log("GetSomeData ret = " + obj.DMF);
			return obj.DMF;
		}

		public static int GetSomeBaseData(this BaseClass obj)
		{
			Logging.HYLDDebug.Log("GetSomeBaseData ret = " + obj.BMF);
			return obj.BMF;
		}
