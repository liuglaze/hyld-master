...
file_path = "D:/unity/hyld-master/hyld-master/Client/Assets/Scripts/Server/Manger/Battle/BattleData.Attack.cs"
...
class_header_new = """    public partial class BattleData
    {
        ...
        // 2. 数据发送:
        //    - `CommandManger.Execute` 每逻辑帧调用 `FlushPendingAttacksToOperation`，将所有待确认的攻击打包进发送给服务端的协议包(selfOperation)中。
        // 3. 权威确认:
...
# 修改 EnqueueAttack 注释
enqueue_old = """        public PendingAttack EnqueueAttack(float towardx, float towardy)"""
...
# 修改 FlushPendingAttacksToOperation 注释
flush_old = """        public void FlushPendingAttacksToOperation()"""
...
# 修改 ConfirmAttacks 注释
confirm_old = """        public void ConfirmAttacks(PlayerOperation authorityOperation)"""
